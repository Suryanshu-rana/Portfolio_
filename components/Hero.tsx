...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-24 pb-16 md:pt-32 relative overflow-hidden bg-android-bg">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="order-2 md:order-1 space-y-6 z-20 text-left flex flex-col items-start justify-center">
          <h3 className="text-2xl font-semibold text-white tracking-wide">Hi There,</h3>
          ...
          <div className="pt-10 flex flex-col sm:flex-row items-center justify-start gap-8">
            ...
            <div className="flex items-center space-x-6">
              <a href={USER_INFO.social.linkedin} className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#0077b5] transition-all transform hover:scale-110">
                <i className="fab fa-linkedin-in text-lg"></i>
              </a>
              <a href={USER_INFO.social.github} className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#333] transition-all transform hover:scale-110">
                <i className="fab fa-github text-lg"></i>
              </a>
              <a href={USER_INFO.social.twitter} className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#1DA1F2] transition-all transform hover:scale-110">
                <i className="fab fa-twitter text-lg"></i>
              </a>
              <a href={`mailto:${USER_INFO.social.email}`} className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#EA4335] transition-all transform hover:scale-110">
