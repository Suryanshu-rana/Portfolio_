...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-24 bg-android-light-bg dark:bg-android-surface/30 scroll-mt-28 relative overflow-hidden min-h-screen flex flex-col items-center justify-center transition-colors duration-300">
      <div className="container mx-auto px-6 relative z-10">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative bg-gray-900 rounded-[2.5rem] p-3 shadow-2xl border border-gray-800 transition-all duration-500 transform group-hover:-translate-y-3 group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] h-[400px]">
                    ...
                    <div className="w-full h-full bg-white dark:bg-android-surface rounded-[1.75rem] overflow-hidden relative z-10 flex flex-col" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
                      ...
                      {/* Content Section */}
                      <div className="flex-1 p-4 flex flex-col bg-white dark:bg-android-surface relative">
                        {/* Subtle gradient at top of content */}
                        <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-black/5 dark:from-black/10 to-transparent pointer-events-none"></div>

                        <div className="flex justify-between items-start mb-2">
                          <h3 className="text-base font-bold text-gray-900 dark:text-white group-hover:text-android transition-colors line-clamp-1">{project.title}</h3>
        ...
        <div className={`text-center mt-12 transition-opacity duration-1000 delay-[1200ms] ${hasTriggered ? 'opacity-100' : 'opacity-0'}`}>
          <a href="https://github.com/Suryanshu-rana" className="inline-flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-android transition-colors border-b border-transparent hover:border-android pb-1 text-sm tracking-wide">
